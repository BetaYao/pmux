...
impl TopBarEntity {
    ...
    fn render_workspace_tab(
        ...
        div()
            ...
            .when(!is_active, |el: Stateful<Div>| {
                el.hover(|style: StyleRefinement| style.bg(rgb(0x2c313a)))
            })
            .cursor_pointer()
            ...
            // Center: tab name (centered) + active agent badge after title
            .child(
                div()
                    .flex_1()
                    .min_w(px(0.))
            ...
            .child(
                div()
                    ...
                    .flex_shrink_0()
                    .hover(|style: StyleRefinement| style.text_color(rgb(0xc0c8d5)).bg(rgb(0x4b5263)))
                    .cursor_pointer()
